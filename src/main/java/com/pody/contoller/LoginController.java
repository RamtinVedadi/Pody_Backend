...
public interface LoginController {
    ...
    @PostMapping(value = UrlStringMapping.URL001, consumes = APPLICATION_JSON_UTF8_VALUE, produces = APPLICATION_JSON_UTF8_VALUE)
    ResponseEntity signupWithEmail(User u);

    @PostMapping(value = UrlStringMapping.URL011, consumes = APPLICATION_JSON_UTF8_VALUE, produces = APPLICATION_JSON_UTF8_VALUE)
    ResponseEntity signupWithPhone(StringRequestDto dto);

    @PostMapping(value = UrlStringMapping.URL002, consumes = APPLICATION_JSON_UTF8_VALUE, produces = APPLICATION_JSON_UTF8_VALUE)
